...
<script> 
$(function(){
	$('span.bread-crumb:contains(home)').click(function(){ 
    ...
    frmTestKitCode.send = function(){
        if (!frmTestKitCode.reportValidity())
            return;
    ...
    <form name="frmTestQuestions" id="frmTestQuestions" action="" onsubmit="return false;">
        ...
        <div class="form-group" id="frmTestQuestions_symptoms">
            ...
            MakeCheckBoxGroup('symptoms', [
                ...
                'numbness'=>'Tingling / Numbness in hands or feet',
...
<!-- 'id'=>'patient-COVID-test3-modal',
    ...
    <div id="patient-COVID-test-thankyou" style="bottom: 10%">
       <!--  <p>Thank you for submitting your answers.</p>
        <p>You may now proceed to the patient testing area!</p> -->
        <p>Questionnaire Complete!</p><br>
        <p>Please go to the check-in station</p>
...
@component('controls.modal',[
    'id'=>'patient-COVID-PCRCode-modal',
    'breadCrumbs'=>[
        ['caption'=>'home'],
        ['id'=>'patient-COVID-test1-modal','caption'=>'Facility'],
        ['id'=>'patient-COVID-test2-modal','caption'=>'Questions']
    ...
    <div style="text-align: center; display: flex; flex-direction: column; max-width: 32pc; margin:auto">
        <p>{{__('Questionnaire Complete')}}</p>
        <p>
            {{__('Please enter the Kit Activation Code')}} <br/>
            {{__('attached to your Viracor SARS-CoV-2 test kit in the space below.')}}
        </p>
        <form name="frmTestKitCode" method="post" onsubmit="return false;">
            @csrf
            <input name="TestKitCode" type="text" class="form-control" style="margin: 1pc 0;" required/>
            <input name="btnSend" type="button" value="Submit"  onclick="frmTestKitCode.send()" class="btn btn-primary form-control"/>
        </form>
    </div>
...
{{-- -------------------------------------------------------------------------- Send Patient Home After Test Kit --}}

@component('controls.modal',[
    'id'=>'patient-COVID-KitDone-modal',
    'breadCrumbs'=>[]
])
