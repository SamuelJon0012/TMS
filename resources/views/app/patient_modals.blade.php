        ...
        <div class="sorry-modal-inner">
            <div id="page-content">
                ...
                <div class="sorry-main">
                    ...
                    <br/>
                    <br/>
                    <span class="btn btn-primary close-all" style="width: 300px;">{{ __('Home Page') }}</span>
                </div>
            </div>
        </div>
    </div>
...
<h1 style="text-align:center;">{{ __('TrackMy Vaccines Help') }}</h1>

<div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
    <main role="main" class="inner cover">
        <div id="viewer-div" rel="/files/default/help.html?601da043ace03">
            <h3>{{ __('Welcome to TrackMy Vaccines a feature of TrackMy Solutions&#153') }}</h3>
            <p>{{ __('At TrackMy we are focused on the Double E, Double I of Healthcare - E²i² (Engage, Educate, Inform, Involve), thus anything we can do to assist you with
            ...
            <h2>{{ __('Patient Call Center:  1-844-522-5952') }}</h2>
            <p>{{ __('9am-5pm 7 days a week EST') }}</p>
