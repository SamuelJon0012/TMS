...
<div class="container">
    <div class="row justify-content-center">
      @if((request()->get('rt') == "patient") or ($isProvider))
        ...
        <form method="POST" name="frmRegister" action="/labResults/new-patient" onsubmit="return frmRegister_validate()">
          @csrf
...
@endif
                ...
                <div class="form-group row justify-content-center">
                  ...
                  <div class="col-md-12 text-center">
                    NOTICE: By clicking Register, you agree to our <a target="_blank" href="/labResults/terms">Terms</a> and that you have read our <a target="_parent" href="/labResults/policy">Privacy policy</a>.
