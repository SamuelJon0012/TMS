                            ...
                            <div class="col-md-10">
                                @if (Route::has('password.request'))
                                  <div class="text-right">
                                    <a class="btn btn-link" href="/labResults/ForgotPassword">
...
<!--                                   <option value="provider">{{ __('I am a Provider') }}</option> -->
    ...
    <div class="text-center">
        ...
        <br/>
        [
        <a href="/labResults/terms" target="_blank">{{ __('Terms') }}</a>
        |
        <a href="/labResults/policy" target="_blank">{{ __('Privacy policy') }}</a>
        ]
